...
// This type is the standard for Three.js uniforms
type IUniforms = { [uniform: string]: THREE.IUniform<any> };
...
const DotMatrix: React.FC<DotMatrixProps> = ({
  ...
  // Correctly format uniforms as THREE.IUniforms
  const uniforms = React.useMemo<IUniforms>(() => {
    let colorsArray = [
      colors[0],
      colors[0],
      colors[0],
...
const ShaderMaterial = ({
  ...
  const material = useMemo(() => {
    const finalUniforms: IUniforms = { ...uniforms };
